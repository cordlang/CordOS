...
const char *const i18n_codes[I18N_LANG_COUNT] = {
    "es", "en"
};

const char *const i18n_names[I18N_LANG_COUNT] = {
    "Español", "English"
};

const u8 i18n_day_first[I18N_LANG_COUNT] = {
    1u, 0u
};

const char *const i18n_date_joins[I18N_LANG_COUNT] = {
    " de ", " "
};

const char *const i18n_weekdays[I18N_LANG_COUNT][7] = {
    { "Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado" },
    { "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" },
};

const char *const i18n_months[I18N_LANG_COUNT][12] = {
    { "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre" },
    { "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" },
};

const char *const i18n_months_abbr[I18N_LANG_COUNT][12] = {
    { "ene", "feb", "mar", "abr", "may", "jun", "jul", "ago", "sep", "oct", "nov", "dic" },
    { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" },
};

const char *const i18n_strings[I18N_LANG_COUNT][MSG_COUNT] = {
    {
        ...
        [MSG_HELP_LANG] = "  ticks  mem  lang [codigo]  exit",
        ...
        [MSG_HOME_ACTIVITY] = "Actividad",
        [MSG_HOME_LOGOUT] = "Cerrar sesión",
        [MSG_HOME_POWER] = "Apagar",
        [MSG_HOME_HINT] = "Win+Espacio busca  doble clic en iconos  F1 shell",
        ...
        [MSG_ACT_CPU] = "Procesador",
        [MSG_ACT_RAM] = "Memoria",
        [MSG_ACT_GPU] = "Pantalla",
        [MSG_ACT_NET] = "Red",
        [MSG_ACT_DISK] = "Disco",
        [MSG_ACT_SYS] = "Sistema",
        [MSG_ACT_PREEMPT_ON] = "preempt activo",
        [MSG_ACT_PREEMPT_OFF] = "preempt apagado",
        [MSG_ACT_HEAP] = "monton del kernel",
        [MSG_ACT_NO_3D] = "Sin GPU 3D · framebuffer",
        [MSG_ACT_LINK] = "Enlace arriba",
        [MSG_ACT_DOWN] = "Sin enlace",
        [MSG_ACT_NO_NIC] = "Sin NIC",
        [MSG_ACT_PERSIST] = "Disco del sistema",
        [MSG_ACT_INITRD] = "Solo initrd",
        [MSG_ACT_BLK] = "volumenes",
        [MSG_ACT_TASKS] = "tareas",
        [MSG_ACT_SPAN] = "12 s",
        [MSG_ACT_UTIL] = "Uso",
        [MSG_ACT_LIVE] = "en vivo",
        [MSG_ACT_CORE] = "nucleo logico",
        [MSG_ACT_AC] = "Corriente",
        [MSG_ACT_BAT] = "Bateria",
        [MSG_ACT_KTASKS] = "Tareas del kernel",
        [MSG_ACT_USED] = "Usado",
        [MSG_ACT_TOTAL] = "Total",
        [MSG_ACT_READY] = "lista",
        [MSG_ACT_RUN] = "en CPU",
        [MSG_ACT_BLOCK] = "espera",
        [MSG_SPOTLIGHT_PLACE] = "Búsqueda Spotlight",
        [MSG_SPOTLIGHT_APPS] = "Aplicaciones",
        [MSG_SPOTLIGHT_FILES] = "Documentos",
        [MSG_SPOTLIGHT_NONE] = "Sin resultados",
    ...
    },
    {
        ...
        [MSG_HELP_CMDS] = "  help  echo  clear  ls  cat  ping [ip]  net",
        [MSG_HELP_LANG] = "  ticks  mem  lang [code]  exit",
        ...
        [MSG_HOME_ACTIVITY] = "Activity",
        [MSG_HOME_LOGOUT] = "Sign out",
        [MSG_HOME_POWER] = "Shut down",
        [MSG_HOME_HINT] = "Win+Space to search  double-click icons  F1 shell",
        ...
        [MSG_ACT_CPU] = "Processor",
        [MSG_ACT_RAM] = "Memory",
        [MSG_ACT_GPU] = "Display",
        [MSG_ACT_NET] = "Network",
        [MSG_ACT_DISK] = "Disk",
        [MSG_ACT_SYS] = "System",
        [MSG_ACT_PREEMPT_ON] = "preempt on",
        [MSG_ACT_PREEMPT_OFF] = "preempt off",
        [MSG_ACT_HEAP] = "kernel heap",
        [MSG_ACT_NO_3D] = "No 3D GPU · linear framebuffer",
        [MSG_ACT_LINK] = "Link up",
        [MSG_ACT_DOWN] = "No link",
        [MSG_ACT_NO_NIC] = "No NIC",
        [MSG_ACT_PERSIST] = "System disk",
        [MSG_ACT_INITRD] = "initrd only",
        [MSG_ACT_BLK] = "volumes",
        [MSG_ACT_TASKS] = "tasks",
        [MSG_ACT_SPAN] = "12 s",
        [MSG_ACT_UTIL] = "Utilization",
        [MSG_ACT_LIVE] = "live",
        [MSG_ACT_CORE] = "logical core",
        [MSG_ACT_AC] = "AC power",
        [MSG_ACT_BAT] = "Battery",
        [MSG_ACT_KTASKS] = "Kernel tasks",
        [MSG_ACT_USED] = "Used",
        [MSG_ACT_TOTAL] = "Total",
        [MSG_ACT_READY] = "ready",
        [MSG_ACT_RUN] = "running",
        [MSG_ACT_BLOCK] = "blocked",
        [MSG_SPOTLIGHT_PLACE] = "Spotlight Search",
        [MSG_SPOTLIGHT_APPS] = "Applications",
        [MSG_SPOTLIGHT_FILES] = "Documents",
        [MSG_SPOTLIGHT_NONE] = "No Results",
